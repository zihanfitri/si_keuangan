...
class Laporan_jajan extends CI_Controller {

	private $parents = 'Laporan_jajan';
    ...
    function Cetak_periode(){
      ...
      //  $pdf->Image(base_url().'/assets/dist/img/tut_wuri_handayani.png', 3, 12, 28);
       ...
       $pdf->Cell(3,8,'',0,1);
       $pdf->SetFont('TIMES','',12);
       $pdf->Cell(10, 5, 'Laporan Jajan Pertanggal : '.tanggal($awal,'bulan').' - '.tanggal($akhir,'bulan'), 0, 1);
