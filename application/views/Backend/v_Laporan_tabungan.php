...
<?= form_open($this->uri->segment(1).'/cetak_periode','id = "form"')?>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="cetak" terget="_blank" class="btn btn-primary">Cetak</button>
            </div>
<?= form_close()?>
        </div>
    </div>
	...
	$(document).ready(function(){
       ...
       table =  $("#list-data").DataTable({
            ...
            columns: [
                ...
                {"data": "tanggal"},
                {"data": "masuk",render: $.fn.dataTable.render.number('.',',','')},
                {"data": "keluar",render: $.fn.dataTable.render.number('.',',','')},
        ...
        //         $.ajax({
        //             url: "<?=base_url('Laporan_tabungan/Cetak_periode')?>",
        //             type:"POST",
        //             data: isi,
        //             dataType:"JSON",
