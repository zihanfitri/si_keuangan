<div class="col-xs-12">
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Data Kas Tabungan</h3>
...
<div class="modal fade" id="modal-form">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-tabungan" method="post">
...
function tambah() {
    $('#form-tabungan')[0].reset();
    $('.modal-title').text('Tambah Data Tabungan');
...
function edit(id) {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.modal-title').text('Edit Data Tabungan');
            $('#modal-form').modal('show');
        },
...
function detail(id) {
    document.location.href= "<?php echo base_url('Tabungan/Detail/')?>"+id;
}
...
$('#form-tabungan').submit(function(e) {
    ...
    var url;
    if($('#id').val() == '') {
        url = "<?php echo site_url('Tabungan/Simpan')?>";
    } else {
        url = "<?php echo site_url('Tabungan/Update')?>";
    }
    $.ajax({
        url : url,
        type: "POST",
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Terjadi kesalahan saat menambah / memperbarui data!',
            });
        }
    });
});
